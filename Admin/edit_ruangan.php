                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="table table">
                          <table class="table">
                            <form method="post" enctype="multipart/form-data" action="edit_prosesruangan.php">
                            <input type="hidden" name="id" class="form-control" value=<?= $id ?> required>
                            <div class="form-group">
                                <label>Nama Ruangan</label>
                                <input type="text" name="nama_ruangan" class="form-control" value=<?= $myjson["nama_ruangan"] ?>>
                            </div>
                            <div class="form-group">
                                <label>Lokasi</label>
