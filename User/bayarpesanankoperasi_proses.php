...
// pesanan_koperasi
$id=$_POST["id"];
$produkkoperasi_id=$_POST["produkkoperasi_id"];
...
curl_close($ch);
# Print response.
echo "<script>alert('Transaksi Berhasil. Terimakasih Banyak!!');window.location='listpemesanankoperasi.php'</script>";  
}else{
  echo "<script>alert('Transaksi Gagal. Saldo tiddak cukup!!');window.location='listpemesanankoperasi.php'</script>";  
